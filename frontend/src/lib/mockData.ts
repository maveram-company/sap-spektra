...
export const mockRunbooks = [
  { id: 'RB-ASE-001', name: 'Dump tran log + kill old tx', costSafe: true, auto: true, dbType: 'ASE', category: 'SAP_ASE', description: 'Trunca el transaction log y elimina transacciones antiguas bloqueadas', totalRuns: 112, successRate: 97.3, avgDuration: '18s' },
  { id: 'RB-ASE-002', name: 'Expand EBS log volume', costSafe: false, auto: false, dbType: 'ASE', category: 'SAP_ASE', description: 'Expande el volumen EBS del log. Requiere aprobación por costo de infra', totalRuns: 24, successRate: 95.8, avgDuration: '3m 20s' },
  { id: 'RB-ASE-003', name: 'Combined log truncate + disk', costSafe: false, auto: false, dbType: 'ASE', category: 'SAP_ASE', description: 'Trunca log + expansión de disco combinado', totalRuns: 8, successRate: 100, avgDuration: '4m 10s' },
  { id: 'RB-HANA-001', name: 'Reclaim HANA memory', costSafe: true, auto: true, dbType: 'HANA', category: 'SAP_HANA', description: 'Ejecuta garbage collection y limpia SQL cache de HANA', totalRuns: 156, successRate: 98.1, avgDuration: '8s', prereqs: ['hdbsql accessible', 'HANA online', 'Memory > 60%'], txCode: 'DBACOCKPIT' },
  { id: 'RB-HANA-002', name: 'Expand HANA disk', costSafe: false, auto: false, dbType: 'HANA', category: 'SAP_HANA', description: 'Expande disco HANA. Requiere aprobación', totalRuns: 32, successRate: 96.9, avgDuration: '2m 15s', prereqs: ['AWS permissions verified', 'EBS volume modifiable', 'No active snapshot'], txCode: 'DB02' },
  { id: 'RB-HA-001', name: 'Resume replication lag', costSafe: true, auto: true, dbType: 'HANA', category: 'HANA_HA', description: 'Reanuda replicación HANA System Replication', totalRuns: 18, successRate: 94.4, avgDuration: '12s', prereqs: ['HSR configured', 'Secondary reachable', 'No takeover in progress'], txCode: 'DBACOCKPIT' },
  { id: 'RB-JVM-001', name: 'Force GC', costSafe: true, auto: true, dbType: 'ALL', category: 'SAP_JAVA', description: 'Fuerza garbage collection en JVM heap', totalRuns: 87, successRate: 93.1, avgDuration: '5s' },
  { id: 'RB-JVM-002', name: 'Force OldGen GC', costSafe: true, auto: true, dbType: 'ALL', category: 'SAP_JAVA', description: 'Fuerza GC de OldGen para liberar memoria', totalRuns: 45, successRate: 95.6, avgDuration: '7s' },
  { id: 'RB-PO-001', name: 'Restart adapter framework', costSafe: true, auto: true, dbType: 'PO', category: 'SAP_JAVA', description: 'Reinicia framework de adaptadores SAP PO', totalRuns: 42, successRate: 90.5, avgDuration: '35s' },
  { id: 'RB-ABAP-001', name: 'Clean sessions + restart WPs', costSafe: true, auto: true, dbType: 'ABAP', category: 'SAP_ABAP', description: 'Limpia sesiones y reinicia work processes', totalRuns: 134, successRate: 96.3, avgDuration: '12s', prereqs: ['sapcontrol accessible', 'No active batch jobs on WPs', 'Free dialog WPs > 2'], txCode: 'SM50' },
  { id: 'RB-BACKUP-001', name: 'Verify backup status', costSafe: true, auto: true, dbType: 'ALL', category: 'CROSS_PLATFORM', description: 'Verifica estado de backups de BD', totalRuns: 198, successRate: 99.5, avgDuration: '4s' },
  { id: 'RB-CERT-001', name: 'Check certificate expiry', costSafe: true, auto: true, dbType: 'ALL', category: 'CROSS_PLATFORM', description: 'Valida certificados ICM/PSE', totalRuns: 64, successRate: 100, avgDuration: '3s' },
  { id: 'RB-WP-001', name: 'Clean PRIV/Hold WPs', costSafe: true, auto: true, dbType: 'ABAP', category: 'SAP_ABAP', description: 'Limpia work processes en PRIV mode o Hold', totalRuns: 98, successRate: 96.9, avgDuration: '10s' },
  { id: 'RB-RFC-001', name: 'Diagnose RFC queues', costSafe: true, auto: true, dbType: 'ABAP', category: 'SAP_ABAP', description: 'Diagnostica colas tRFC/qRFC/bgRFC', totalRuns: 56, successRate: 98.2, avgDuration: '6s' },
  { id: 'RB-JOB-001', name: 'Check failed/long jobs', costSafe: true, auto: true, dbType: 'ABAP', category: 'SAP_ABAP', description: 'Revisa jobs fallidos o de larga duración (SM37)', totalRuns: 87, successRate: 93.1, avgDuration: '5s' },
  { id: 'RB-HOUSE-001', name: 'Housekeeping', costSafe: true, auto: true, dbType: 'ABAP', category: 'SAP_ABAP', description: 'Limpieza de spool, logs, TEMSE y datos temporales', totalRuns: 72, successRate: 97.2, avgDuration: '45s' },
  { id: 'RB-LOCK-001', name: 'Lock management SM12', costSafe: true, auto: true, dbType: 'ABAP', category: 'SAP_ABAP', description: 'Diagnostica y limpia enqueue locks antiguos', totalRuns: 34, successRate: 100, avgDuration: '8s' },
  { id: 'RB-TRANS-001', name: 'Transport monitoring STMS', costSafe: true, auto: true, dbType: 'ABAP', category: 'SAP_ABAP', description: 'Monitorea cola de transportes y detecta bloqueados', totalRuns: 44, successRate: 97.7, avgDuration: '7s' },
];
