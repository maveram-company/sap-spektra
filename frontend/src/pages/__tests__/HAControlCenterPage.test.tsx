...
vi.mock('../../mode/ModeContext', () => ({
  useMode: () => ({
    ...
    setMode: () => {},
    getDomainCapability: () => ({ domain: 'ha', tier: 'real', readOnly: false, degraded: false, confidence: 'high', source: 'api' }),
  }),
}));
...
vi.mock('../../services/dataService', () => {
  ...
  return {
    dataService: {
      getHASystems: vi.fn().mockResolvedValue(haSystems),
    ...
    getHASystemsResult: vi.fn().mockResolvedValue({
      data: haSystems,
      source: 'real',
      confidence: 'high',
